...
class antunesServices {
    ...
    private scrapePage(pageContent: any, ) {
        return new Promise(async (resolve, reject) => {
            ...
            for (let i = 0; i < arrayProducts.length; i++) {
                ...
                produto.market = mongoose.Types.ObjectId("5d31084c753423bec9a73146")    //Antunes - 7 de setembro
    ...
    async scrape() {
        return new Promise(async (resolve, reject) => {
            ...
            const baseUrl: string = "https://www.sitemercado.com.br/antunes/catanduva-loja-sete-de-setembro-higienopolis-rua-sete-de-setembro"
            ...
            await page.goto(baseUrl).then(async () => {
                ...
                while (arrayTemp.length > 0) {
                    ...
                    let urls: any[] = arrayTemp.splice(0, 8)
...
export const antunesService = new antunesServices()
